...
public:
    ...
    // Constructor 1 ÔÇö current date and time
    clsDate()
    {
        time_t now = time(0);
        tm localTime;
    ...
    // Constructor 2 ÔÇö from string "dd/mm/yyyy"
    clsDate(string date)
    {
    ...
    // Constructor 3 ÔÇö from day, month, year
   ...
   // Getters & Setters
    ...
    static int daysInMonth(clsDate date)
    {
        ...
        return (date.getMonth() == 2)
            ...
            : numberOfDays[date.getMonth() - 1]; // ÔåÉ ┘âÏº┘å getDay() Ï«ÏÀÏú
    }
